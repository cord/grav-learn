...
There are four tabs in the **Page Editor** area of the admin. Three of these tabs are core to Grav, while the fourth is generated by the template (also known as page type) assigned to the page. In this guide, we will document the three primary tabs as the fourth one is unique for every theme and/or template.
